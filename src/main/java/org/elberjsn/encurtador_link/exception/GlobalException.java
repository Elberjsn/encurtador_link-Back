...
public class GlobalException {
    ...
    public ResponseEntity<String> valicadaoHibernate(ConstraintViolationException ex) {
        List<String> mensagensDeErro = ex.getConstraintViolations().stream().map(ConstraintViolation::getMessage)
    ...
    public ResponseEntity<String> erroTokenCriacao(JWTCreationException ex) {
    ...
    public static ResponseEntity<String> custom(CustomError error) {
      return ResponseEntity.status(HttpStatusCode.valueOf(error.getStatusCode())).body(error.getMessage());
    }
    @ExceptionHandler(RuntimeException.class)
    public ResponseEntity<String> runError(RuntimeException ex) {
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(ex.getMessage());
    }
}
